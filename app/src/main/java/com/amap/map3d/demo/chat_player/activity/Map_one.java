...
public class Map_one extends AppCompatActivity implements LocationSource, AMapLocationListener {
        ...
        if (amapLocation != null) {
            if (amapLocation.getErrorCode() == 0) {
                ...
                if (isFirstLoc) {
                    ...
                    aMap.moveCamera(CameraUpdateFactory.changeLatLng(new LatLng(app.getLatitude(), app.getLongitude())));
