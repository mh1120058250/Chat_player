package com.amap.map3d.demo.chat_player.db;
...
import com.amap.map3d.demo.chat_player.db.dao.DaoMaster;
import com.amap.map3d.demo.chat_player.db.dao.DaoSession;
import com.amap.map3d.demo.chat_player.db.dao.NewFriendDao;
